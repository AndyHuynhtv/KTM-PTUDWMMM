...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/template/admin/dist/css/usercart.css">
    <script src="/template/admin/dist/js/card.js"></script>
  </head>
  <body>
    <div class="menu1">
      <div class="nav-bar1">
        <ul class="nav justify-content-end">
          ...
          <div class="dropdown-menu dropdownmenu">
            ...
            <a class="dropdown-item" href="{{route('userCart')}}">Giỏ hàng của tôi</a>
        ...
        <div class="product-show-detail">
          <div class="container">
            ...
            @if(session('cart'))
                    ...
                    <tbody>
                        ...
                        @foreach(session('cart') as $id => $product)
                            <tr>
                                ...
                                <!-- Hiển thị các thông tin sản phẩm khác -->
                            </tr>
                ...
                {{-- <a href="{{ route('placeOrder') }}" class="btn btn-primary">Đặt hàng</a> --}}
                <!-- Link đến route xử lý đặt hàng -->
                <form method="POST" action="{{ route('placeOrder') }}">
                  ...
                  <!-- Chi tiết đơn hàng -->
                  <!-- Danh sách sản phẩm được đặt hàng -->
