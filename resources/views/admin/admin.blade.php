  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="mb-3">
        ...
        <a href="{{ route('userAdmin') }}" class="btn btn-primary">Trang chủ</a>
       
        {{-- <a href="{{ route('admin.edit', ['id' => session('user')->id]) }}" class="btn btn-primary">Chỉnh sửa</a> --}}
  ...
  <div class="row">
      ...
      <div class="col-md-3 mb-4">
          <div class="card product-card">
              ...
              <div class="card-body">
                  <h5 class="card-title">Tên rượu: {{ $product->title }}</h5>
                  <p class="card-text">Mô tả: {{ $product->description }}</p>
                  <p class="card-text">Giá gốc: {{ number_format($product->price) }}đ</p>
                  @if($product->discount)
                      <p class="card-text">Giá giảm: {{ number_format($product->discount) }}đ</p>
                  @endif
                  <div class="button-container">
                      <a href="{{ route('editProduct', ['id' => $product->id]) }}" class="btn btn-primary">Chỉnh sửa</a>
