  ...
  <body>
      ...
      <div class="nav-bar1">
        ...
        @endif
          ...
          <div class="dropdown-menu dropdownmenu">
            {{-- <form method="GET" action="{{ route('editForm', ['id' => session('user')->id]) }}">
              @csrf
              <button type="submit" class="dropdown-item">Thay đổi thông tin</button>
          </form> --}}
          

            <a class="dropdown-item" href="{{route('paypal-checkout')}}">Giỏ hàng của tôi</a>
    ...
    <div class="navbar-hover-c2">
      ...
      <div class="navbar-hover-4">
        ...
        <div class="content-product" style="width: 100%; margin-left: 60px;">

<!-- Trong red_wines.blade.php -->
<h1>Danh sách sản phẩm vang đỏ</h1>

@if($redWines->isEmpty())
    <p>Không có sản phẩm vang đỏ.</p>
@else
    <div class="product-list">
        @foreach($redWines as $wine)
            <div class="product">
                ...
                <img src="{{ asset($wine->image) }}" alt="{{ $wine->name }}" width="150">
...
<div class="content-product" style="width: 100%; margin-left: 60px;">
    ...
    <div class="col-md-2">
        <div class="d-flex flex-column">
            <div class="p-2">
                <img src="{{ asset($wine->thumbnail) }}" alt="{{ $wine->title }}" />
            </div>
            <div class="p-2">
              <a href="#"></a>
                <br>
                <p style="margin-bottom:0px;">Giá gốc: {{ number_format($wine->price) }}đ</p>
                <p>Giá giảm:{{ number_format($wine->discount) }}đ</p> <!-- Hiển thị thông tin discount -->
            </div>
        </div>
    </div>
